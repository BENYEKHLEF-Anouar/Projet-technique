...
@section('content')
    <div class="max-w-3xl mx-auto">
        ...
        <div class="space-y-5 md:space-y-8">
            <div class="space-y-3">
                <h2 class="text-2xl font-bold md:text-3xl dark:text-white break-words">{{ $note->name }}</h2>

                <div class="flex items-center gap-x-2">
                    <div class="flex items-center gap-x-2">
                        <div class="flex-shrink-0">
                            <div
                                class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 border border-gray-200 text-xs font-medium text-gray-600">
            ...
            @if($note->image)
                <figure>
                    <img class="w-full object-cover rounded-xl" src="{{ asset('storage/' . $note->image) }}"
                        alt="{{ $note->name }}">
                </figure>
            @endif
