...
<div id="hs-slide-down-animation-modal"
  ...
  <div
    class="hs-overlay-animation-target hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:scale-100 mt-0 opacity-0 scale-95 transition-all duration-200 sm:max-w-lg sm:w-full m-3 sm:mx-auto">
    <div
        ...
        <form id="noteForm" action="{{ route('notes.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <input type="file" id="note-image" name="image"
              ...
              <div id="image-preview" class="hidden mt-2">
                ...
                <img src="" alt="Preview" class="h-20 w-auto rounded-md object-cover border dark:border-neutral-700">
              </div>
            </div>
          </div>
