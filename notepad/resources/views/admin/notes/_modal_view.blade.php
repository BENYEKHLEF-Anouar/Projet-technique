...
<div id="view-note-modal"
  ...
  role="dialog" tabindex="-1" aria-labelledby="view-note-modal-label">
  <div
    ...
    <div
      ...
      <div class="flex justify-between items-center py-3 px-4 border-b border-gray-200 dark:border-neutral-700">
        <h3 id="view-note-title"
          class="font-bold text-lg text-gray-800 dark:text-white leading-tight pr-4 flex-1 break-words overflow-hidden">
          <!-- Title populated by JS -->
        </h3>
        <button type="button"
          class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-neutral-400 dark:focus:bg-neutral-600"
          aria-label="Close" data-hs-overlay="#view-note-modal">
      ...
      <div class="p-4 overflow-y-auto">
        ...
        <div id="view-modal-content" class="hidden space-y-4">
          ...
          <div
            class="flex items-center gap-2 text-sm text-gray-500 mb-4 border-b border-gray-100 pb-3 dark:text-neutral-500 dark:border-neutral-700">
          ...
          <div id="view-note-body"
            class="text-sm text-gray-700 whitespace-pre-line leading-relaxed dark:text-neutral-300"></div>
      ...
      <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t border-gray-200 dark:border-neutral-700">
        <button type="button"
          ...
          data-hs-overlay="#view-note-modal">
          {{ __('Close') }}
        </button>
      </div>
    </div>
