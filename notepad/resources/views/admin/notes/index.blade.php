...
@section('content')
    <div class="container mx-auto p-4 space-y-6">
            ...
            <div class="max-w-sm w-full">
                <div class="relative" data-hs-combo-box='{
                    ...
                    <div class="relative">
                        ...
                        <input id="category-filter-display" class="py-3 px-4 ps-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" 
                        ...
                        <input type="hidden" id="category-filter" value="{{ request('category_id', '') }}">
                    </div>
        ...
        <!-- Table Container -->
        @include('admin.notes._table')

        @include('admin.notes._modal')

        {{-- Success Message for JS usage --}}
