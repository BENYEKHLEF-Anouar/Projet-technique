...
class HomeController extends Controller
{
    ...
    // CategoryService $categoryService: Resolved from the service container.

    public function index(Request $request, NoteService $noteService, CategoryService $categoryService)
    {
